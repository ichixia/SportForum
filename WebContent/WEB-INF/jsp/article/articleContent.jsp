			...
			<div class="row">
				...
				<div class="floor" id="floor${c.cid }" style="display: none;width: 40%;float: right;">
					...
					<c:choose>
						...
						<c:otherwise>
							<input class="btn btn-primary" type="submit" onClick="unFloorReply()" value="回复" style="float: right;">
						</c:otherwise>
					</c:choose>
				</div>
			</div>
		...
		$.ajax({
			...
			'success' : function(data) {
				...
				var t1 = '<div class="media-left">'+
				  '<a href="${pageContext.request.contextPath}/user/info/${user.uid}"><img class="media-object" src="${user.headimg }" style="width:34px;"></a>'+
				'</div>'+
				'<div class="media-body">'+
