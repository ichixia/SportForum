  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="password" id="password" maxlength="20"  class="form-control" placeholder="密码"><br>
        <input type="text" id="id_num" maxlength="20"  class="form-control" placeholder="身份证号">
      </div>
