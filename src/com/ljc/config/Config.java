...
public class Config {
	 ...
	 * 默认文件上传地址
	 */
	public static final String DEFAULT_UPLOAD_ADDRESS = File.separator+"resources"+File.separator+"upload" ;// "/resources/upload"
	 ...
	 * 管理员登录授权码 
	 */
	public static final String ADMIN_Authorization_Code = "5201314";
